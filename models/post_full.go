...
// ContextValidate validate this post full based on the context it is used
func (m *PostFull) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PostFull) contextValidateAuthor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PostFull) contextValidateForum(ctx context.Context, formats strfmt.Registry) error {

	if m.Forum != nil {
		if err := m.Forum.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("forum")
			}
			return err
...
func (m *PostFull) contextValidatePost(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PostFull) contextValidateThread(ctx context.Context, formats strfmt.Registry) error {
