...
const CreateThreadRequest = "INSERT INTO threads(thread_id,title,author,message,created,forum_id)" +
	" VALUES(default,$1,$2,$3,$4,$5)"

const GetExistThreadReuqest = "SELECT thread_id,title,author,message,votes,slug,created FROM threads WHERE title=$1"
...
const GetThreadsFromForum = "SELECT thread_id,t.title,author,message,votes,t.slug,created FROM forums as f INNER JOIN threads as t on t.forum_id=f.forum_id WHERE f.slug=$1"
